  ...
  <div class="min-h-screen bg-white flex">
    ...
    >
      <div class="mx-auto w-full max-w-sm lg:w-96 ">
        <div>
          <img
            class="h-12 w-auto bg-green-700"
            ...
            <div>
              ...
              <div class="mt-1 grid grid-cols-3 gap-3">
                <div>
                  <a
                    href="#"
                    class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-green-500 hover:bg-gray-50"
                  >
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <label
                    for="remember_me"
                    class="ml-2 block text-sm text-green-900"
                  >
                    Remember me
                  </label>
                </div>
    ...
    <div class="hidden lg:block relative w-0 flex-1">
      <img
        ...
        src="https://mega3.vercel.app/img/header_bg_main.jpg"
        alt=""
      />
    </div>
  </div>
