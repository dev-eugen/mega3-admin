    ...
    <div class="py-6 px-4 sm:p-6 lg:pb-8">
     <div class="bg-white py-6 px-4 space-y-6 sm:p-6 ">
          ...
          <div class="px-4 py-3  text-right sm:px-6">
            <button type="submit" class=" bg-indigo-600 border border-transparent rounded-full shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
              Save
            </button>
          </div>
    </div>
