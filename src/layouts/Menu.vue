    ...
    <div class="hidden lg:flex lg:flex-shrink-0">
      <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-gray-100">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems
                ...
                <div class="py-1">
                  ...
                  <a :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">View
                    profile</a>
                  </MenuItem>
                  <MenuItem v-slot="{ active }">
                  <a href="#" :class="[
          ...
          <nav class="px-3 mt-6">
            <div class="space-y-1">
              <a v-for="item in navigation" :key="item.name" @click="$router.push({ name: item.href })" :class="[
                  item.current
                ...
                <a v-for="(item, i) in navigation" :key="item.name" @click="go(item.href, i) "
