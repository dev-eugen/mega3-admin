<template>
  <div
    class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 grid grid-cols-3 p-2 items-center">
    <div>
      <h1 class="text-lg font-medium leading-6 text-gray-700 sm:truncate">
        {{ title }}
      </h1>
    </div>
